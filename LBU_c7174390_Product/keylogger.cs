...
namespace dotnet_keylogger
{
    class keylogger
    {
        ...
        private static KeylogQ kQ = new KeylogQ();
        ...
        public static void Main ()
            ...
            if (p.Length > 1)
                Environment.Exit(0);
            if (MessageBox.Show(ConsentText, "Disclaimer", (MessageBoxButtons)1) == DialogResult.Cancel)
            {
                Environment.Exit(0);
            }
            string username = ObtainUsername();
            string filepath = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) +
                @"\_sg_" + pname + "_" + username + @".csv";
        ...
        public static string ConsentText = "This application will collect and analyse keyboard activity for the " +
            "benefit of academic research into the viability for continuously authenticating a user by their keyboard" +
            "habits and, conversely, detecting an intruder by the sudden change of keyboard activity patterns.  " +
            Environment.NewLine + Environment.NewLine +
            "This application will immediately cease the collection and analysis of data as soon as its closed. " +
            "Verbose key logs will never be stored or transmitted from this application however it will be used to " +
            "derive metrics such as specific timing data for high frequency words or letter combinations.  These metrics" +
            "will then be stored and transmitted.  At any point you may request a copy of this data." +
            Environment.NewLine + Environment.NewLine +
            "This research will result in an academic paper which will be published and you may request a copy of " +
            "this paper.  You will not be identified in the paper and whilst your metrics may be referenced in the " +
            "research, the complete dataset will not be published and your confidentiality will be maintained." + 
            Environment.NewLine + Environment.NewLine +
            "You may at any point request that your data is deleted." +
            Environment.NewLine + Environment.NewLine +
            "By continuing to use this application, you agree and understand the above statement.";
    }
